...
<ul class="list-group list-group-flush">
  ...
  <div class="card-body">
    ...
    <div>
  ${employee.getRole() === "Manager" ? `<li class="list-group-item">
  Office Number: ${employee.officeNumber}
</li>`: employee.getRole() === "Intern" ? ` <li class="list-group item">
...
</svg><h6>School:</h6><p>${employee.school}</li></p> 
...
<a href="https://github.com/" class="card-link"> GitHub: ${employee.github}</a>
</li>`
      }
  </ul>
  `;
