...
function generateHTML(employee) {
  const managerC = filterTeam.map(function (item) {
    return item`<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-badge-fill" viewBox="0 0 16 16">
...
`
  ...
  <a href="#" class="card-link"> GitHub: ${employee.github}</a>`
  })

  const internC = team.map(function (item) {
    return item`
  <li class="list-group item">
